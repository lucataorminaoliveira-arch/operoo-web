...
export default function QRCodesPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto" data-testid="qrcodes-page">
      {/* Header */}
      <div>
        ...
        <CardContent className="p-6 sm:p-8">
          <div className="grid gap-8 sm:grid-cols-2 items-center">
            ...
            <div className="space-y-5">
              ...
              {/* Actions */}
              <Button variant="outline" className="gap-2 w-full" onClick={downloadQR} data-testid="download-qr-button">
